...
void game(Card arraygame[], Card arraylayer1[], Card arraylayer2[], Card arraylayer3[], Card arraylayer4[], Card arraydeck[])
{
	...
	while (strcmp(loop, "enter") == 0) {
		...
		case 7:
			...
			break;
		case 8:
			autoResolution(arraygame, arraylayer1, arraylayer2, arraylayer3, arraylayer4, arraydeck);
			break;
		default:
			printf("\nInvalid choice \n");
			break;
...
/*
Function to play automatically game/ Fonction pour resoudre le jeu automatiquement
  @param : arraygame : card of game / Packet de carte du jeu
  @param : arraylayer1 : card of layer 1 / Packet de carte de la couche 1
  @param : arraylayer2 : card of layer 2 / Packet de carte de la couche 2
  @param : arraylayer3 : card of layer 3 / Packet de carte de la couche 3
...
void autoResolution(Card arraygame[], Card arraylayer1[], Card arraylayer2[], Card arraylayer3[], Card arraylayer4[], Card arraydeck[])
{
	...
	int x = 0;
	arraygame[x] = arraydeck[deckDraws];
	deckDraws--;
	while (nbCardZeroInGame != 28)
	{
		printf("hand:%d nb:%d", hand, nbCardZeroInGame);
...
void toZero(Card arraygame[], Card layer[], int* pointercardplay)
{
	...
	layer[*pointercardplay - 1].symbol = '0';
}
